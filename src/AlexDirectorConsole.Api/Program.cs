...
builder.Services.AddScoped<IDirectorTool, QueryStoryboardTool>();
...
builder.Services.AddScoped<IDirectorTool, PurgeProjectResourceVersionsTool>();
...
builder.Services.AddScoped<GenerateComfyUiVideoTool>();
builder.Services.AddScoped<IDirectorTool>(services => services.GetRequiredService<GenerateComfyUiVideoTool>());
builder.Services.AddScoped<IDirectorTool, GenerateComfyUiVideosBatchTool>();
...
builder.Services.AddScoped<IDirectorTool, AssembleProjectVideoTool>();
builder.Services.AddScoped<IDirectorTool, StartFullProductionTool>();
builder.Services.AddScoped<IDirectorTool, GetFullProductionStatusTool>();
...
builder.Services.AddSingleton<ILocalMediaAssemblyService, LocalMediaAssemblyService>();
...
builder.Services.AddScoped<IProductionSkillRunner, ProductionSkillRunner>();
builder.Services.AddScoped<IProductionRunExecutor, ProductionRunExecutor>();
builder.Services.AddSingleton<IAzureVmLifecycleService, AzureVmLifecycleService>();
builder.Services.AddHostedService<ProductionRunWorker>();
